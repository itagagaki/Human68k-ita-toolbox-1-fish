...
remove_colon_loop:
		bsr	count_command_word
		tst.w	d2
		beq	remove_colon_skip_args

		cmpi.b	#':',(a0)
		bne	remove_colon_skip_args
		...
		subq.w	#1,d3
		subq.w	#1,d2
remove_colon_skip_args:
		move.w	d2,d0
		bsr	fornstrs
		sub.w	d2,d5
		beq	remove_colon_done

		bsr	for1str
		subq.w	#1,d5
		bra	remove_colon_loop
